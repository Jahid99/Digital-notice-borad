<?php include 'inc/header.php'; ?>
    <div class="container">
      <div class="row">
        <h2>Approved Blood Requests</h2><hr>
          ...
          if($donors){ ?>
            <table class="table table-bordered" id="example">
                    ...
                    <?php $i=0;
                      while ($result = $donors->fetch_assoc()) { $i++;?>
                        ...
                        <tr class="odd gradeX">
                          ...
                          <td><a href="sendbloodrequest.php?blood_group=<?php echo $result['blood_type']; ?>">Send SMS to <?php echo $result['blood_type']; ?> Donors</a> || <a onclick="return confirm('Are you sure to delete');" href="?del=<?php echo $result['id']; ?>">Delete</a></td>
                        </tr>
                        <?php } ?>
               ...
               <?php
                      ...
                      echo '<center><h2 style="color:red">No approved request found...</h2></center>';
                    }
